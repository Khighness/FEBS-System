...
-- Records of t_dept
-- ----------------------------
INSERT INTO `t_dept` VALUES (1, 0, '餐厅部', 10, '2019-06-14 20:56:41', '2020-07-15 10:55:58');
...
INSERT INTO `t_dept` VALUES (12, 0, '研发部', 1, '2020-07-20 19:53:33', NULL);
...
-- ----------------------------
INSERT INTO `t_eximport` VALUES ('字段1', 1, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 2, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 3, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 4, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 5, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 6, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 7, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 8, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 9, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 10, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 11, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 12, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 13, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 14, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 15, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 16, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 17, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 18, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 19, 'parakovo@gmail.com', '2021-06-27 06:02:56');
INSERT INTO `t_eximport` VALUES ('字段1', 20, 'parakovo@gmail.com', '2021-06-27 06:02:56');
...
-- ----------------------------
INSERT INTO `t_generator_config` VALUES (1, 'Khighness', 'top.parak.febs.gen', 'entity', 'mapper', 'mapper', 'service', 'service.impl', 'controller', '1', 't_');
...
-- Records of t_job
-- ----------------------------
INSERT INTO `t_job` VALUES (1, 'testTask', 'test1', 'Khighness', '0/1 * * * * ?', '1', '有参任务调度测试', '2021-06-27 06:22:38');
INSERT INTO `t_job` VALUES (2, 'testTask', 'test2', NULL, '0/10 * * * * ?', '1', '无参任务调度测试', '2021-06-27 06:22:38');
INSERT INTO `t_job` VALUES (3, 'testTask', 'test1', 'Hello, Wolrd', '0/1 * * * * ?', '1', '有参任务调度测试,每隔一秒触发', '2021-06-27 06:22:38');
INSERT INTO `t_job` VALUES (4, 'testTask', 'test2', NULL, '0/5 * * * * ?', '1', '测试异常', '2021-06-27 06:22:38');
...
) ENGINE = MyISAM AUTO_INCREMENT = 1024 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_log
-- ----------------------------
INSERT INTO `t_log` VALUES (1025, 'K', '恢复定时任务', 79, 'top.parak.febs.job.controller.JobController.resumeJob()', ' jobIds: \"1,2,3,4\"', '192.168.117.133', '2021-06-27 15:09:30', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES (1026, 'K', '暂停定时任务', 82, 'top.parak.febs.job.controller.JobController.pauseJob()', ' jobIds: \"1,2,3,4\"', '192.168.117.133', '2021-06-27 15:19:43', '内网IP|0|0|内网IP|内网IP');
...
) ENGINE = MyISAM AUTO_INCREMENT = 116 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_login_log
-- ----------------------------
INSERT INTO `t_login_log` VALUES (116, 'K', '2021-06-27 10:48:34', '内网IP|0|0|内网IP|内网IP', '192.168.117.133', 'Windows 10', 'Chrome 91');
INSERT INTO `t_login_log` VALUES (117, 'K', '2021-06-27 10:50:16', '内网IP|0|0|内网IP|内网IP', '192.168.117.133', 'Windows 10', 'Chrome 91');
INSERT INTO `t_login_log` VALUES (118, 'K', '2021-06-27 11:01:27', '内网IP|0|0|内网IP|内网IP', '192.168.117.133', 'Windows 10', 'Chrome 91');
...
INSERT INTO `t_role_menu` VALUES (81, 8);
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 'K', '2e0b2e4d225e64803b702937b3224021', 12, 'parakovo@gmail.com', '13611339958', '1', '2020-06-14 20:39:22', '2021-06-27 10:59:01', '2021-06-27 14:42:29', '0', '1', 'black', '20180414165827.jpg', 'K');
INSERT INTO `t_user` VALUES (2, 'Scott', '1d685729d113cfd03872f154939bee1c', 10, 'scott@gmail.com', '17722222222', '1', '2020-06-14 20:55:53', '2019-06-14 21:05:43', '2020-06-25 18:20:56', '0', '1', 'black', 'gaOngJwsRYRaVAuXXcmB.png', '我是scott。');
INSERT INTO `t_user` VALUES (3, 'Reina', '1461afff857c02afbfb768aa3771503d', 4, 'Reina@hotmail.com', '17711111111', '0', '2020-06-14 21:07:38', '2019-06-14 21:09:06', '2019-06-14 21:08:26', '1', '1', 'black', '5997fedcc7bd4cffbd350b40d1b5b987.jpg', '由于公款私用，已被封禁。');
INSERT INTO `t_user` VALUES (4, 'Micaela', '9f2daa2c7bed6870fcbb5b9a51d6300e', 10, 'Micaela@163.com', '17733333333', '1', '2020-06-14 21:10:13', '2019-06-14 21:11:26', '2019-06-14 21:10:37', '0', '0', 'white', '20180414165909.jpg', '我叫米克拉');
INSERT INTO `t_user` VALUES (5, 'Jana', '176679b77b3c3e352bd3b30ddc81083e', 8, 'Jana@126.com', '17744444444', '1', '2020-06-14 21:12:16', '2019-06-14 21:12:52', '2019-06-14 21:12:32', '1', '1', 'white', '20180414165821.jpg', '大家好，我叫简娜');
INSERT INTO `t_user` VALUES (6, 'Georgie', 'dffc683378cdaa015a0ee9554c532225', 3, 'Georgie@qq.com', '17766666666', '0', '2020-06-14 21:15:09', '2019-06-14 21:16:25', '2019-06-14 21:16:11', '2', '0', 'black', 'BiazfanxmamNRoxxVxka.png', '生产执行rm -rf *，账号封禁T T');
INSERT INTO `t_user` VALUES (7, 'Margot', '31379841b9f4bfde22b8b40471e9a6ce', 9, 'Margot@qq.com', '13444444444', '1', '2020-06-14 21:17:53', '2019-06-14 21:18:59', '2019-06-14 21:18:07', '1', '1', 'white', '20180414165834.jpg', '大家好我叫玛戈');
INSERT INTO `t_user` VALUES (8, 'Khighness', 'c9d2a880e29fc7849f0c03fe510fc942', 1, '1823676372@qq.com', '13611339958', '1', '2020-06-25 18:22:47', '2020-06-25 18:23:57', '2020-11-22 16:20:40', '0', '1', 'black', 'BiazfanxmamNRoxxVxka.png', 'K殿下呀');
...
INSERT INTO `t_user_role` VALUES (10, 82);
